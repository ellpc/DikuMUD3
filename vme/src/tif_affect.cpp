...
void tif_fear_check(unit_affected_type *af, unit_data *unit)
{
    ...
    if (CHAR_FIGHTING(unit))
    {
        switch (number(0, 2))
        {
            ...
            case 1:
                ...
                break;
            case 2:
                act("You wish your wounds would stop BLEEDING that much!", A_ALWAYS, unit, cActParameter(), cActParameter(), TO_CHAR);
                break;
        }
        return;
    }
    else
    {
        ...
        else
        {
            ...
            {
                case 0:
                    act("Someone tries to steal your weapon!", A_ALWAYS, unit, cActParameter(), cActParameter(), TO_CHAR);
                    break;
                case 1:
                    act("Someone grins evilly.", A_ALWAYS, unit, cActParameter(), cActParameter(), TO_CHAR);
                    break;
                case 2:
                    act("The huge green dragon appears in a puff of smoke!", A_ALWAYS, unit, cActParameter(), cActParameter(), TO_CHAR);
            }
        }
    }
}
